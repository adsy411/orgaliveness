...
public class LabMembersBatchUpload_Action extends TestBase{
	...
	public void LabMembersBatchUpload() throws Exception{
		...
		Reporter.log("Login to Application with specific User Four");
		init();
		...
		Reporter.log("Click Batchupload from Owner Login and upload the Lab Members");
		Thread.sleep(2000);
		...
		Reporter.log("Register the uploaded Lab Members and Verify First and Last Name");
		Thread.sleep(10000);
