...
public class SubStorage_Search extends TestBase
{
	@Test(priority = 1)
	public void AddMaterialPage_SubLocation_Search() throws Exception
	{
		...
		String level1StorageName = ExcelUtils.getCellData(8, 6);
		String level1StorageTemperature = ExcelUtils.getCellData(8, 7);
		String level2StorageName = ExcelUtils.getCellData(24, 6);
		String level2StorageTemperature = ExcelUtils.getCellData(24, 7);
		...
		//verify level 2 sub-storage exists or not
   		...
   		String storageName = level1StorageName+"/"+level2StorageName;
   		
   		//Search for storage
		verifyStorage.AddMaterialPage_SubStorage_Search(level2StorageName, storageName);;
		impliciteWait(1);
