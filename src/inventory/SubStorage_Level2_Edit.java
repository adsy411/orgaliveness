...
public class SubStorage_Level2_Edit extends TestBase
{
	@Test(priority = 1)
	public void AddMaterialPage_Edit_Level2_SubLocation() throws Exception
	{
		...
		String level1StorageName = ExcelUtils.getCellData(6, 6);
		String level1StorageTemperature = ExcelUtils.getCellData(6, 7);
		String level2StorageName = ExcelUtils.getCellData(22, 6);
		String level2StorageTemperature = ExcelUtils.getCellData(22, 7);
		String updatelevel2StorageName = ExcelUtils.getCellData(22, 3);
		String updatelevel2StorageTemperature = ExcelUtils.getCellData(22, 4);
		...
		//verify level 2 sub-storage exists or not
   		...
   		//Edit the level 2 sub-Storage
   		StorageRegularFunctions editLevel2SubLocation = new StorageRegularFunctions();
   		editLevel2SubLocation.AddMaterialPage_Edit_Level2_SubLocation(level2StorageName, level2StorageTemperature, updatelevel2StorageName, updatelevel2StorageTemperature, level1StorageIndex);
