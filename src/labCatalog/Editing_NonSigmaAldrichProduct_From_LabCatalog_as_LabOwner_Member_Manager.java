...
public class Editing_NonSigmaAldrichProduct_From_LabCatalog_as_LabOwner_Member_Manager extends TestBase {
	...
	public void Edit_Lab_Catalog_Product_Created_By_Lab_Owner() throws Exception {
		...
		Thread.sleep(2000);
		if(SelectList.VerifySelectList("AddNewProdcut_UoM",UoM) == true)
			SelectList.SelectByValue("AddNewProdcut_UoM",UoM);
		else
