...
public class AddNonSigmaAldrichProducttoCatalog extends TestBase {

@Test
public void Add_New_NonSigmaAldrich_Product_to_Catalog_as_LabOwner() throws Exception {
...
@Test
public void Add_New_NonSigmaAldrich_Product_to_Catalog_as_LabManager() throws Exception {
...
@Test
public void Add_New_NonSigmaAldrich_Product_to_Catalog_as_LabMember() throws Exception {
	...
	{
		System.out.println("PASS...................................");
		System.out.println("New Non Sigma-Aldrich Product Added to Catalog Successfully");
		Reporter.log("New Non Sigma-Aldrich Product "+ProductName+" Added to Lab Catalog Successfully");
	}
	else
	{
