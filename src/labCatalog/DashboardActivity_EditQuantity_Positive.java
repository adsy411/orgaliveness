...
public class DashboardActivity_EditQuantity_Positive extends TestBase {

@Test
public void VerifyDashboardActivityfor_EditQuantity_Positive() throws Exception {
	...
	//Generate a Random number to search in the Product Name
			...
			String UpdatedProdQuantity = "55.0";
